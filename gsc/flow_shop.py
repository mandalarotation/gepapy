...
class Flow_Shop(Operations):
    def __init__(self,n_samples=10,n_jobs=8,n_operations=3,n_machines=3,processing_time=None,machine_sequence=None,due_date=None,weights,percent_cross=0.2,percent_intra_cross=0.5,percent_mutation=0.2,percent_intra_mutation=0.5,percent_migration=0.1,percent_selection=0.1,fitness_type="max_C"):
