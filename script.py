...
p = Single_Machine(n_samples=100000,n_jobs=20,processing_time=T_,machine_sequence=M_,due_date=d_,weights=w_,percent_cross=0.8,percent_mutation=0.8,percent_migration=0.1,fitness_type="E_Lw")
